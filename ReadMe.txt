...
- Registered users can perform CRUD operations on their contacts
- Protected routes which are only available to authenticated users
- Middleware for error handling and JWT authentication
